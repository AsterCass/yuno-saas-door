    ...
    <div class="col-6">
      ...
      <div class="q-my-md">
        ...
        <div class="row items-center">
          <DatetimeSelector :value="newProjectData.projectStartTime"
                            placeholder="请输入活动周期开始时间" disable
      ...
      <div class="row q-my-md">
        ...
        <div>
          ...
          <div class="row items-center">
            <DatetimeSelector :value="newProjectData.projectTeamDeadlineTime" placeholder="请输入组队截止时间" disable
        ...
        <div>
          ...
          <div class="row items-center">
            <DatetimeSelector :value="newProjectData.projectSignDeadlineTime" placeholder="请输入签约截止时间" disable
      ...
      <div class="q-my-md">
        ...
        <div class="row items-center">
          ...
          <DatetimeSelector :value="newProjectData.projectTeamEndTime" placeholder="请输入组队选房周期截止时间" disable
      ...
      <div class="q-my-md">
        ...
        <div class="row items-center">
          <q-input v-model="newProjectData.projectTeamInterval" color="grey" hide-bottom-space borderless
                   placeholder="请输入组队选房间隔" disable mask="###"
                   input-class="astercasc-input-inner-base"
      ...
      <div class="q-my-md">
        ...
        <div class="row items-center">
          <TimeSelector :value="newProjectData.projectNoPersonalStartTime"
                        placeholder="请输入不可个人选房时段开始时间" disable
          ...
          <TimeSelector :value="newProjectData.projectNoPersonalEndTime"
                        placeholder="请输入不可个人选房时段截至时间" disable
      ...
      <div class="q-my-md">
        ...
        <div class="row items-center">
          <q-input v-model="newProjectData.projectPersonalInterval" color="grey" hide-bottom-space borderless
                   placeholder="请输入个人选房间隔" mask="###" disable
                   input-class="astercasc-input-inner-base"
                   :input-style="inject('globalData').isMiniScreen ? {} : {width: '12rem'} "/>
          <div style="font-size: 1rem">
            分钟
      ...
      <div class="q-my-md">
        ...
        <div class="row items-center">
          ...
          <DateSelector :value="newProjectData.projectHouseCheckEndTime" placeholder="请输入可验房日期截止时间" disable
      ...
      <div class="q-my-md">
        ...
        <div class="row items-center">
          ...
          <TimeSelector :value="newProjectData.projectHouseCheckAmCheckStartTime" placeholder="开始时间" disable
                        componentWidth="10rem"
                        @time-change="(time)=>newProjectData.projectHouseCheckAmCheckStartTime = time"/>
          <div class="text-center" style="width: 3rem">
            至
          </div>
          <TimeSelector :value="newProjectData.projectHouseCheckAmCheckEndTime" placeholder="结束时间" disable
                        componentWidth="10rem"
          ...
          <q-input class="q-ml-md" v-model="newProjectData.projectHouseCheckAmCheckCap" color="grey" hide-bottom-space
                   borderless
                   placeholder="可验房人数" mask="###" disable
                   input-class="astercasc-input-inner-base"
        ...
        <div class="row items-center">
          ...
          <TimeSelector :value="newProjectData.projectHouseCheckPmCheckStartTime" placeholder="开始时间" disable
                        componentWidth="10rem"
                        @time-change="(time)=>newProjectData.projectHouseCheckPmCheckStartTime = time"/>
          <div class="text-center" style="width: 3rem">
            至
          </div>
          <TimeSelector :value="newProjectData.projectHouseCheckPmCheckEndTime" placeholder="结束时间" disable
                        componentWidth="10rem"
...
import {bookProjectDetail} from "@/api/book-project";
